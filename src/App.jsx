          ...
          <div className="action-buttons">
            ...
            >
              <svg viewBox="0 0 24 24" width="24" height="24">
                <path fill="#ffc629" d="M12.5,8c-2.65,0-5.05,0.99-6.9,2.6L2,7v9h9l-3.62-3.62c1.39-1.16,3.16-1.88,5.12-1.88 c3.54,0,6.55,2.31,7.6,5.5l2.37-0.78C21.08,11.03,17.15,8,12.5,8z"/>
              </svg>
            </button>
            ...
            >
              <svg viewBox="0 0 24 24" width="28" height="28">
                <path fill="#ff6e79" d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>
              </svg>
            </button>
            ...
            >
              <svg viewBox="0 0 24 24" width="24" height="24">
                <path fill="#3ba4f6" d="M12,17.27L18.18,21l-1.64-7.03L22,9.24l-7.19-0.61L12,2L9.19,8.63L2,9.24l5.46,4.73L5.82,21L12,17.27z"/>
              </svg>
            </button>
            ...
            >
              <svg viewBox="0 0 24 24" width="32" height="32">
                <path fill="#4ccc93" d="M12,21.35l-1.45-1.32C5.4,15.36,2,12.28,2,8.5C2,5.42,4.42,3,7.5,3c1.74,0,3.41,0.81,4.5,2.09 C13.09,3.81,14.76,3,16.5,3C19.58,3,22,5.42,22,8.5c0,3.78-3.4,6.86-8.55,11.54L12,21.35z"/>
              </svg>
            </button>
            ...
            >
              <svg viewBox="0 0 24 24" width="24" height="24">
                <path fill="#a166ff" d="M13,2.05v2.02c3.95,0.49,7,3.85,7,7.93c0,4.08-3.05,7.44-7,7.93v2.02c5.05-0.5,9-4.76,9-9.95 C22,6.81,18.05,2.55,13,2.05z M12,19c-3.87,0-7-3.13-7-7c0-3.87,3.13-7,7-7v3l4-4l-4-4v3c-5.52,0-10,4.48-10,10s4.48,10,10,10 c3.31,0,6.24-1.61,8.06-4.09l-1.48-1.48C17.33,17.97,14.83,19,12,19z"/>
              </svg>
            </button>
          </div>
        )}
